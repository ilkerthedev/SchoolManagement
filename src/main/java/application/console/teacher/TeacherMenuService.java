...
import core.validations.TeachersIsValidIdValidator;
...
public class TeacherMenuService extends MenuService implements IdMaker {
    ...
    TeachersIsValidIdValidator isValidId = new TeachersIsValidIdValidator();
    ...
    public void add() {
        ...
        tchr.setId(isValidId.isValidId());
